...
function Header(props) {
    return (
        <div>
          <div className='h-10 bg-slate-400 w-full'>
          <marquee width="60%" direction="left" height="100px">
          Admission Open on SS INSTITUTE OF PHARMACY 2024
          -2025  CONTACT US +91 9453018202
</marquee>
          </div>
    ...
    <div class="relative flex  h-16 items-center justify-between">
      ...
      <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        <div class="flex flex-shrink-0 items-center">
          <img class="h-8 w-auto" src='https://ssip.edu.in/wp-content/uploads/2024/07/SSIP_Logo_845x193.png' alt="Your Company"/>
        </div>
        <div class="hidden sm:ml-6 sm:block">
          ...
          <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Home</a>
            ...
            <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Admission</a>
          </div>
        </div>
      </div>
      <div class="  inset-y-0 right-0 flex items-center ">
    
     <h1 className='text-white '>+91 9453018202</h1>
      </div>
    </div>
  </div>
