        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">sirmohan@gmail.com</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">Baurwan saidpur ghazipur 233304</p>
                </div>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 9453018202</p>
                </div>
            </div>
            ...
            <div class="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                <form>
                    ...
                    <div class="mt-4">
                        ...
                        <input type="email" placeholder="email" class="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
